...
def get_deploys(user_id, view_name=None):
    ...
    # with the '+' character: https://code.sei.cmu.edu/bitbucket/projects/S3/repos/s3.player.api/browse/S3.Player.Api/Infrastructure/Mappings/ApplicationProfile.cs#39
